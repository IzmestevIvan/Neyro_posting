...
def triage_prompt(text: str, instructions: str) -> str:
    ...
    return f"""Оцени пост из чужого канала.
...
Верни JSON:
{{
  "is_ad": true/false,          // это реклама, промо, партнёрский материал или призыв купить
  "is_offtopic": true/false,    // не подходит под пожелания владельца
