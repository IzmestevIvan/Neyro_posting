...
TABLES = ("broadcast_recipients", "broadcasts", "support_routes", "service_api_keys", "delivery_attempts", "posts", "ad_offers", "sources", "stats_daily", "channels", "promo_codes", "users", "kv")
